...
#data loading file. Converts datasets to feather objects
...
#Loading shotchart dataset and convert it to feather####
...
all <- full_join(y2018, y2019) %>% full_join(y2020) %>%
...
#Loading Game Logs data (for ind stats modal)####
...
#loading other data from excels ####
